...
public static IArray<T> Build<T>(T init, Func<T, int, T> next, Func<T, int, bool> hasNext)
{
    ...
    return r.ToIArray();
         ...
         /// <summary>
        /// Returns an ISequence containing only elements of the array for which the function returns true on the index.
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<T> WhereIndices<T>(this IArray<T> self, Func<int, bool> f)
            => self.Where((x, i) => f(i));

        /// <summary>
        /// Returns an ISequence containing only elements of the array for which the corresponding mask is true.
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<T> Where<T>(this IArray<T> self, IArray<bool> mask)
            => self.WhereIndices(mask.ToPredicate());

        /// <summary>
        /// Returns an ISequence containing only elements of the array for which the corresponding predicate is true.
        /// </summary>
        public static ISequence<T> Where<T>(this IArray<T> self, Func<T, bool> predicate)
            => self.ToEnumerable().Where(predicate);

        /// <summary>
        /// Returns an ISequence containing only elements of the array for which the corresponding predicate is true.
        /// </summary>
        public static ISequence<T> Where<T>(this IArray<T> self, Func<T, int, bool> predicate)
            => self.ToEnumerable().Where(predicate);
        ...
        /// </summary>
        public static ISequence<IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IArray<TSource> self, Func<TSource, TKey> keySelector)
        ...
        /// </summary>
        public static ISequence<IGrouping<TKey, TElem>> GroupBy<TSource, TKey, TElem>(this IArray<TSource> self, Func<TSource, TKey> keySelector, Func<TSource, TElem> elementSelector)
        ...
        /// <summary>
        /// Returns an ISequence containing only indices of the array for which the function satisfies a specific predicate.
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<int> IndicesWhere<T>(this IArray<T> self, Func<T, bool> f)
        ...
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<int> IndicesWhere<T>(this IArray<T> self, Func<T, int, bool> f)
        ...
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<int> IndicesWhere<T>(this IArray<T> self, Func<int, bool> f)
            => self.Indices().Where(i => f(i));

        /// <summary>
        /// Returns an ISequence containing only indices of the array for which booleans in the mask are true.
        /// An IArray is not created automatically because it is an expensive operation that is potentially unneeded.
        /// </summary>
        public static ISequence<int> IndicesWhere<T>(this IArray<T> self, IArray<bool> mask)
