...
namespace Plato
{
    ...
    {
        public static Sequence<TValue> ToSequence<TValue>(this IIterator<TValue> iterator) => new Sequence<TValue>(iterator);
        ...
        public static IIterator<T> Prepend<T>(this IIterator<T> iter, T x) => x.Unit().Concat(iter);
