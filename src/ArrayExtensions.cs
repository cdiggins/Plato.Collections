...
namespace Plato
{
    ...
    public static class ArrayExtensions
    {
        ...
        public static IArray<T> Flatten<T>(this IArray<IArray<T>> self)
        {
            ...
            var i = 0;
            foreach (var xs in self.Enumerate())
        ...
        /// </summary>
        public static T Aggregate<T>(this IArray<T> self, Func<T, T, T> func)
        ...
        /// </summary>
        public static IRange Indices<T>(this IArray<T> self)
            => self.Count.Range();
        ...
        {
            var n = self.Reverse().IndexOf(x => x.Equals(item));
