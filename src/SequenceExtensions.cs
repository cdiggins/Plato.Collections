...
namespace Plato
{
    public static class SequenceExtensions
    {
        ...
        public static EmptySequence<T> Empty<T>(this T _) => EmptySequence<T>.Instance;

        public static EmptySequence<T> Empty<T>() => EmptySequence<T>.Instance;

        public static IRange Range(this int n) => Range(0, n);

        public static IRange Range(this int n, int upto) => new RangeSequence(n, upto);
        ...
        public static T First<T>(this ISequence<T> seq) => seq.Iterator.First();
        ...
        public static ISequence<T> Prepend<T>(this ISequence<T> seq, T x) => seq.Iterator.Prepend(x).ToSequence();
